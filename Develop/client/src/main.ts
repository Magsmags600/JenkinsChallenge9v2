...
// // // Corrected fetchWeather function to use the 'city' field in the request body
// // const fetchWeather = async (cityName: string) => {
// //   const response = await fetch('/api/weather/', {
// //     method: 'POST',
// //     headers: {
// //       'Content-Type': 'application/json',
// //     },
// //     body: JSON.stringify({city: cityName }), // Correct field name
// //   });
...
// // // Corrected fetchSearchHistory function to fetch history
// // const fetchSearchHistory = async () => {
...
// //   if (!response.ok) {
// //     console.error('Failed to delete city from history');
// //   }
// // };
